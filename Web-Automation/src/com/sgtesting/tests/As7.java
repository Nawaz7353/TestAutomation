...
public class As7{
	...
	public static void createCustomer()
	{
		try
		{
			...
			n.findElement(By.id("customerLightBox_nameField")).sendKeys("customer1");
			Thread.sleep(2000);
	...
	public static void createTask()
	{
		...
		{
			n.findElement(By.xpath("//*[@id='taskListBlock']/div[1]/div[1]/div[3]/div")).click();
			Thread.sleep(3000);
			n.findElement(By.xpath("/html/body/div[13]/div[1]")).click();
			Thread.sleep(3000);
			n.findElement(By.xpath("//*[@id='createTasksPopup_createTasksTableContainer']/table/tbody/tr[1]/td[1]/input")).sendKeys("sales");
			Thread.sleep(3000);
			n.findElement(By.xpath("//*[@id=\'createTasksPopup_commitBtn\']/div/span")).click();
			Thread.sleep(3000);
			n.findElement(By.xpath("//*[@id=\'closeCreateTasksPopupButton\']")).click();
			Thread.sleep(3000);
	...
	public static void deletetask()
	{
		try
		{
			/*	//	n.findElement(By.xpath("//*[@id='taskListBlock']/div[1]/div[2]/div[1]/table[2]/tbody/tr/td[1]/div/div")).click();
			n.findElement(By.xpath("//*[@id='taskListBlock']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[1]/div/div")).click();
			Thread.sleep(3000);
			//*[@id='taskListBlock']/div[1]/div[3]/div/div/div[4]
			//*[@id='taskListBlock']/div[1]/div[3]/div/div/div[4]
			//*[@id='taskListBlock']/div[1]/div[3]/div/div/div[4]
			n.findElement(By.xpath("//*[@id='taskListBlock']/div[1]/div[3]/div/div/div[4]")).click();
			Thread.sleep(3000);
			//*[@id='deleteTaskPopup_deleteConfirm_submitTitle']
			n.findElement(By.xpath("//*[@id='deleteTaskPopup_deleteConfirm_submitBtn']")).click();
			Thread.sleep(3000);*/


			n.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[2]/div/div[2]")).click(); 
			Thread.sleep(2000);
			n.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[1]/div[2]/div[3]/div/div/div[2]")).click();
			Thread.sleep(2000);

			n.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[4]/div/div[3]/div")).click();
			Thread.sleep(2000);
			n.findElement(By.xpath("//*[@id=\'taskPanel_deleteConfirm_submitTitle\']")).click();
			Thread.sleep(2000);
	...
	public static void modifytask()
	{
		...
		{     n.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[2]/div/div[2]")).click(); 
		Thread.sleep(2000);
		n.findElement(By.xpath("//*[@id='taskListBlock']/div[3]/div[2]/div[1]/div[2]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("get lost idiot");
		Thread.sleep(2000);
		n.findElement(By.xpath("//*[@id='taskListBlock']/div[3]/div[1]/div[1]")).click();
		Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
